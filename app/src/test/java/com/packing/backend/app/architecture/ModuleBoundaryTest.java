...
class ModuleBoundaryTest {
    ...
    static final ArchRule postgresDriverStaysInTheConstraintTranslator = noClasses()
                                                                                    .that()
                                                                                    .resideOutsideOfPackage("com.packing.backend.infra.persistence.shared")
                                                                                    .should()
                                                                                    .dependOnClassesThat()
    ...
    static final ArchRule layersRespectTheDependencyDirection = layeredArchitecture()
                                                                                     ...
                                                                                     .mayOnlyBeAccessedByLayers("App")
                                                                                     .whereLayer("Core")
                                                                                     .mayOnlyBeAccessedByLayers("Api", "Infra", "App")
                                                                                     .whereLayer("Domain")
                                                                                     .mayOnlyBeAccessedByLayers("Core", "Api", "Infra", "App");
}
